-- ==============================================================================
-- VALMONT GADGETS — FULL SUPABASE SETUP (run once)
-- Creates all tables, indexes, categories, storage bucket, admin user,
-- and RLS policies. Safe to re-run (everything uses IF NOT EXISTS / ON CONFLICT).
-- ==============================================================================

CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- Drop tables from any previous partial run (safe — no live data yet)
...
-- Categories: public reads all, admin does everything
...
-- Orders: anon can create (checkout), admin does everything
...
-- Customers: anon can create (checkout), admin does everything
...
-- Reviews: public reads approved, anyone can insert, admin does everything
...
CREATE POLICY "Allow public read approved reviews"
  ON public.reviews FOR SELECT TO anon USING (is_approved = true);
...
-- Storage: public reads images, authenticated admin uploads/updates/deletes
