...
const DEFAULT_PRODUCTS_SEED = [
  ...
  { id: "vmp-006", name: "iPhone 13", slug: "iphone-13", category: "iphones", price: 9800, wholesale_price: 8200, compare_at_price: 11270, specs: "A15 Bionic", description: "iPhone 13", badge: "DEAL", rating: 4.4, reviews_count: 12, stock_quantity: 20, image_url: "", image: "/assets/assets/images/products/iphone-13.jpg", images: [], colors: [], storage_options: [], is_active: true },
  { id: "vmp-007", name: "iPhone 11", slug: "iphone-11", category: "iphones", price: 7200, wholesale_price: 5900, compare_at_price: 8280, specs: "A13 Bionic", description: "iPhone 11", badge: "", rating: 4.3, reviews_count: 9, stock_quantity: 14, image_url: "", image: "/assets/assets/images/products/iphone-13.jpg", images: [], colors: [], storage_options: [], is_active: true },
  ...
  { id: "vmp-013", name: "Samsung Galaxy S24 Ultra", slug: "samsung-galaxy-s24-ultra", category: "samsung", price: 15200, wholesale_price: 12800, compare_at_price: 17480, specs: "Titanium, S Pen, 200MP", description: "Galaxy S24 Ultra", badge: "SEALED", rating: 4.8, reviews_count: 6, stock_quantity: 12, image_url: "", image: "/assets/assets/images/products/iphone-13.jpg", images: [], colors: [], storage_options: [], is_active: true },
  { id: "vmp-014", name: "Samsung Galaxy S24", slug: "samsung-galaxy-s24", category: "samsung", price: 12800, wholesale_price: 10700, compare_at_price: 14720, specs: "Snapdragon 8 Gen 3", description: "Galaxy S24", badge: "", rating: 4.7, reviews_count: 9, stock_quantity: 15, image_url: "", image: "/assets/assets/images/products/iphone-13.jpg", images: [], colors: [], storage_options: [], is_active: true },
  { id: "vmp-015", name: "Samsung Galaxy S23 Ultra", slug: "samsung-galaxy-s23-ultra", category: "samsung", price: 13500, wholesale_price: 11300, compare_at_price: 15525, specs: "200MP Camera", description: "Galaxy S23 Ultra", badge: "HOT", rating: 4.6, reviews_count: 8, stock_quantity: 10, image_url: "", image: "/assets/assets/images/products/iphone-13.jpg", images: [], colors: [], storage_options: [], is_active: true },
  { id: "vmp-016", name: "Samsung Galaxy S23", slug: "samsung-galaxy-s23", category: "samsung", price: 10500, wholesale_price: 8800, compare_at_price: 12075, specs: "Flagship 2023", description: "Galaxy S23", badge: "", rating: 4.5, reviews_count: 11, stock_quantity: 17, image_url: "", image: "/assets/assets/images/products/iphone-13.jpg", images: [], colors: [], storage_options: [], is_active: true },
  { id: "vmp-017", name: "Samsung Galaxy A55", slug: "samsung-galaxy-a55", category: "samsung", price: 6800, wholesale_price: 5600, compare_at_price: 7820, specs: "Exynos 1480", description: "Galaxy A55", badge: "DEAL", rating: 4.4, reviews_count: 7, stock_quantity: 25, image_url: "", image: "/assets/assets/images/products/iphone-13.jpg", images: [], colors: [], storage_options: [], is_active: true },
  { id: "vmp-018", name: "Samsung Galaxy A35", slug: "samsung-galaxy-a35", category: "samsung", price: 5200, wholesale_price: 4300, compare_at_price: 5980, specs: "Mid-range 2024", description: "Galaxy A35", badge: "", rating: 4.3, reviews_count: 6, stock_quantity: 30, image_url: "", image: "/assets/assets/images/products/iphone-13.jpg", images: [], colors: [], storage_options: [], is_active: true },
  ...
  { id: "vmp-021", name: "Samsung Galaxy A25", slug: "samsung-galaxy-a25", category: "samsung", price: 4200, wholesale_price: 3500, compare_at_price: 4830, specs: "Budget 2024", description: "Galaxy A25", badge: "DEAL", rating: 4.2, reviews_count: 5, stock_quantity: 28, image_url: "", image: "/assets/assets/images/products/iphone-13.jpg", images: [], colors: [], storage_options: [], is_active: true },
  { id: "vmp-022", name: "Samsung Galaxy S24 FE", slug: "samsung-galaxy-s24-fe", category: "samsung", price: 9200, wholesale_price: 7700, compare_at_price: 10580, specs: "Fan Edition", description: "Galaxy S24 FE", badge: "", rating: 4.5, reviews_count: 3, stock_quantity: 9, image_url: "", image: "/assets/assets/images/products/iphone-13.jpg", images: [], colors: [], storage_options: [], is_active: true },
  { id: "vmp-023", name: "Samsung Galaxy A15", slug: "samsung-galaxy-a15", category: "samsung", price: 3200, wholesale_price: 2650, compare_at_price: 3680, specs: "Entry-level", description: "Galaxy A15", badge: "", rating: 4.1, reviews_count: 4, stock_quantity: 35, image_url: "", image: "/assets/assets/images/products/iphone-13.jpg", images: [], colors: [], storage_options: [], is_active: true },
...
function updateWishlistBadge() {
  if (wishlistCountBadge) {
    ...
    wishlistCountBadge.setAttribute("data-count", count);
  }
  // Also handle alternative IDs used in tasks
  const altWishlist = document.getElementById("wishlist-count");
  if (altWishlist) {
    const count = wishlist.length;
    altWishlist.textContent = count > 0 ? count : "";
    altWishlist.setAttribute("data-count", count);
  }
  document.querySelectorAll(".nav-badge").forEach(b => {
    // keep generic badges in sync if they represent wishlist
    if (b.id && b.id.includes("wishlist")) {
      b.textContent = wishlist.length > 0 ? wishlist.length : "";
      b.setAttribute("data-count", wishlist.length);
    }
  });
}
...
function updateCartBadge() {
  if (cartBadgeCount) {
    ...
    cartBadgeCount.textContent = total > 0 ? total : "";
    cartBadgeCount.setAttribute("data-count", total);
  }
  const altCart = document.getElementById("cart-count");
  if (altCart) {
    const total = cart.reduce((sum, item) => sum + item.qty, 0);
    altCart.textContent = total > 0 ? total : "";
    altCart.setAttribute("data-count", total);
  }
  document.querySelectorAll(".nav-badge").forEach(b => {
    if (b.id && b.id.includes("cart")) {
      const total = cart.reduce((sum, item) => sum + item.qty, 0);
